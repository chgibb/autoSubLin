...
export class Bowtie2AllSubLinAlign extends Task<Array<string>,string>
{
    public name : string;
    ...
    public constructor(inputs : Array<string>,modifier : string)
    {
        ...
        this.execStrings = [
            `./tools/bowtie2 -p 4 --sensitive-local -x out/raw/HPV16_all_refs -1 ${inputs[0]} -2 ${inputs[1]} -S ${modifier}`
        ];
    }
