...
export class Bowtie2AllSubLinAlignUnpairedVSL extends Task<string,string>
{
    public name : string;
    ...
    public constructor(input : string,modifier : string)
    {
        ...
        this.execStrings = [
            `./tools/bowtie2 -p 4 --very-sensitive-local -x out/raw/HPV16_all_refs -U ${input} -S ${modifier}`
        ];
    }
